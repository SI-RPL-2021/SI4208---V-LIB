    ...
    <div class="row" style="margin-left: 150px; margin-top: 100px">
        ...
        <div class="col-md-6">
            <img style="width: 60%;" src="<?php echo e(asset('img/vlib.png')); ?>" alt="">
        </div>
    </div>
    

    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SBAdmin2VLib\resources\views/about.blade.php ENDPATH**/ ?>