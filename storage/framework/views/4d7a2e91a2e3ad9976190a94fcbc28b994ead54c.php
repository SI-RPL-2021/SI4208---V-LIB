...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="text-align: center;"><?php echo e(__('Register')); ?></div>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="container">
                                <label style="margin-left: 17.5%;" for="name"><?php echo e(__('Name')); ?>*</label>
                                <input style="width: 65%; margin-left: 17.5%; border: 1.5px solid #cacaca; border-radius: 60px; padding: 20px;" id="name" type="text" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <div class="container">
                                <label style="margin-left: 17.5%;" for="email"><?php echo e(__('E-Mail Address')); ?>*</label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="container">
                                <label style="margin-left: 17.5%;" for="password-confirm"><?php echo e(__('Confirm Password')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RPL\resources\views/auth/register.blade.php ENDPATH**/ ?>